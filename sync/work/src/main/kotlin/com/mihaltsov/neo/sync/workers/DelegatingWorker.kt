 ...
 * delegate to
 */
internal fun KClass<out CoroutineWorker>.delegatedData(): Data {
    return Data.Builder()
...
class DelegatingWorker(
    ...
    private val delegateWorker =
        EntryPointAccessors.fromApplication<HiltWorkerFactoryEntryPoint>(appContext).hiltWorkerFactory()
